...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.db;
 ...
 */
public class dbConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "db test case")
